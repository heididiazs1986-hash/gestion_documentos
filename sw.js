const CACHE_NAME="gs-documentos-cache-v25";
const APP_SHELL=["./","./index.html?v=gsdoc-v25","./manifest.json?v=gsdoc-v25","./gs-docs-icon-192.png?v=gsdoc-v25","./gs-docs-icon-512.png?v=gsdoc-v25"];
