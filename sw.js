const CACHE='gs-docs-v55-1';
const CORE=['./','./index.html','./manifest.json','./gs-docs-icon-192.png','./gs-docs-icon-512.png','./templates/Constancia_TD.pdf','./v55-hotfix.js'];
...
const HOTFIX='<script src="./v55-hotfix.js?v=gsdoc-v55-1"></script>';
...
async function pageWithHotfix(request){
  ...
  if(!html.includes('v55-hotfix.js'))html=html.replace('</body>',HOTFIX+'\n</body>');
