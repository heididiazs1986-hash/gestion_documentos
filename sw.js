const CACHE='gs-docs-v73';
const CORE=['./','./index.html','./manifest.json','./gs-docs-icon-192.png','./gs-docs-icon-512.png','./templates/Constancia_TD.pdf','./v73-render-fix.js'];
...
const HOTFIX='<script src="./v73-render-fix.js?v=gsdoc-v73"></script>';
...
async function pageWithV73(request){
  let response;
  ...
  if(!html.includes('v73-render-fix.js'))html=html.replace('</body>',HOTFIX+'\n</body>');
...
self.addEventListener('fetch',e=>{
  ...
  if(isAppPage){e.respondWith(pageWithV73(e.request));return;}
